...
const questions = [
  {
    q: 'O que é Cross Merchandising?',
    options: ['Técnica de exposição conjunta de produtos complementares', 'Venda de produtos importados', 'Promoção relâmpago', 'Troca de mercadorias entre lojas'],
    answer: 0,
  },
  {
    q: 'Qual é o principal objetivo do Cross Merchandising?',
    options: ['Reduzir estoque', 'Aumentar o ticket médio', 'Diminuir o número de funcionários', 'Mudar o layout da loja'],
    answer: 1,
  },
  {
    q: 'Exemplo de Cross Merchandising: macarrão + ?',
    options: ['Sabão em pó', 'Molho de tomate', 'Desinfetante', 'Papel higiênico'],
    answer: 1,
  },
  {
    q: 'Onde é melhor posicionar produtos de Cross Merchandising?',
    options: ['No estoque', 'Próximo ao produto principal', 'Na entrada da loja', 'Perto dos caixas apenas'],
    answer: 1,
  },
  {
    q: 'Qual combinação NÃO é um bom exemplo de Cross Merchandising?',
    options: ['Churrasco + carvão', 'Café + filtro de papel', 'Shampoo + arroz', 'Vinho + queijo'],
    answer: 2,
  },
  {
    q: 'O Cross Merchandising pode ser aplicado em qual setor?',
    options: ['Apenas em alimentos', 'Apenas em higiene', 'Em todos os setores', 'Apenas em bebidas'],
    answer: 2,
  },
  {
    q: 'Qual ferramenta é essencial para planejar o Cross Merchandising?',
    options: ['Planograma', 'Nota fiscal', 'Folha de pagamento', 'Balanço patrimonial'],
    answer: 0,
  },
  {
    q: 'Quem deve participar do planejamento de Cross Merchandising?',
    options: ['Apenas o gerente', 'Apenas o fornecedor', 'Toda a equipe da loja', 'Apenas o RH'],
    answer: 2,
  },
  {
    q: 'Qual a frequência ideal para atualizar as ações de Cross Merchandising?',
    options: ['Uma vez por ano', 'Nunca', 'Regularmente, conforme sazonalidade', 'A cada 5 anos'],
    answer: 2,
  },
  {
    q: 'O que acontece quando o Cross Merchandising é bem executado?',
    options: ['Aumento de custos', 'Queda nas vendas', 'Aumento das vendas e satisfação do cliente', 'Nada muda'],
    answer: 2,
  },
  {
    q: 'Qual destes é um benefício indireto do Cross Merchandising?',
    options: ['Fidelização do cliente', 'Aumento do aluguel', 'Redução de salários', 'Demissão de funcionários'],
    answer: 0,
  },
];
